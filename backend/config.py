...
MODEL_PARAMS = {
    'lambda': .189,                # Rate of Poisson jumps
    'jump_median_pct': 0.119,      # Median percentage jump in income
    'jump_q25': 0.031,             # 25th percentile of jump sizes
    'jump_q75': 0.361,             # 75th percentile of jump sizes
    'prob_upward': 0.599,            # Probability that income jump is upward (50%)
}
